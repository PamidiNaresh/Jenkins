...
def createNewJenkinsJobWithMultiBranch(String projectsview, String projectName, String destProject, String destGit, String githubid) {
    ...
    multibranchPipelineJob("${projectsView}/${destProject}") {
    branchSources {
        github {
