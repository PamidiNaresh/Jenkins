...
EOF"""
                  sh  "npm install sonarqube -Dsonar.projectKey=com.mcd.${orgName}:${projectName} -Dsonar.projectName=${projectName} -Dsonar.testExecutionReportPaths=${test-report-path}"
                }else {
